...
Welcome to the AI Resume Tailor documentation! All project documentation is now organized in this folder.
...
- **[CLEANUP_SUMMARY.md](./phases/CLEANUP_SUMMARY.md)** - Project cleanup summary
...
See the [phases](./phases/) folder for detailed phase documentation.
