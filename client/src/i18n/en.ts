export const en = {
  ...
  seo: {
    landing: {
      ...
      description:
        "Free AI-powered resume analysis tool. Get instant match scores, missing keywords, and actionable suggestions to optimize your resume for any job. No signup required.",
      keywords:
    ...
    analyze: {
      ...
      description:
        "Get instant AI-powered analysis of your resume against any job description. See your match score, missing keywords, and improvement suggestions in 60 seconds.",
  ...
  header: {
    ...
    tagline: "Powered by AI • Free Forever",
    toasts: {
  ...
  analyze: {
    ...
    messages: {
      freeLimitReached: "You’ve used your {{total}} free analyses. Please create a free account to continue.",
    ...
    faq: {
      ...
      items: {
        q1: {
          ...
          answer:
            "No! Simply paste your resume and job description to get instant results. No signup, no email required.",
        },
        q2: {
          question: "Is my data stored or shared?",
          answer:
            "Never. Analysis happens in real-time and nothing is saved to our servers. Your resume and personal information remain completely private.",
        },
        q3: {
          question: "What AI model powers this?",
          answer:
            "We use GPT-4 Turbo, the same advanced AI that powers ChatGPT Plus. It’s trained on thousands of successful resumes and job descriptions.",
        },
        q4: {
          question: "Does it work for all industries?",
          answer:
            "Yes! Our AI analyzes any resume against any job description, from tech and finance to healthcare and creative fields.",
        },
        q5: {
          question: "How accurate is the analysis?",
          answer:
            "Our AI provides objective analysis based on keyword matching, semantic similarity, and professional writing standards. While no tool is perfect, our users report 85% average match scores.",
        },
        q6: {
          question: "Can I analyze multiple resumes?",
          answer:
            "Absolutely! There’s no limit. Analyze as many resume-job combinations as you need, completely free.",
        },
      },
    },
    finalCta: {
