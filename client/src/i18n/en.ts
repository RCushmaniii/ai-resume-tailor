export const en = {
  ...
  pricing: {
    ...
    benefits: {
      ...
      rewriteDesc: "Instantly integrate missing keywords naturally into your bullet points.",
      coverLetter: "Custom Cover Letter Generator",
      coverLetterDesc: "Personalized for this specific job description.",
  ...
  checkout: {
    ...
    successMessage: "Your payment was successful. You now have full access to all Pro features.",
    successMessageWithAccount: "Your account is ready! You now have full access to all Pro features.",
    unlockedFeatures: "Your Pro Benefits",
    feature1: "AI Resume Rewriter - Optimize your resume instantly",
    feature2: "Custom Cover Letter Generator",
    feature3: "50 analyses per month",
    feature4: "Interview prep questions",
    confirmationSent: "A confirmation email has been sent to",
    startAnalyzing: "Start Analyzing Your Resume",
    supportNote: "Questions? Contact us at support@airesume.tailor",
    createAccount: {
      title: "Payment Successful!",
      subtitle: "Create your account to access your Pro features",
      ...
      whyCreate: "Create an account to manage your subscription and save analyses",
      errors: {
