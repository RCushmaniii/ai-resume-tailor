export const es = {
  ...
  pricing: {
    ...
    benefits: {
      rewrite: "Reescritor de CV con IA",
      rewriteDesc: "Integra palabras clave faltantes de forma natural en tus puntos.",
      coverLetter: "Generador de Carta de Presentación",
      coverLetterDesc: "Personalizada para esta vacante específica.",
  ...
  checkout: {
    ...
    pleaseWait: "Por favor espera mientras confirmamos tu compra.",
    errorTitle: "Problema con el Pago",
    tryAgain: "Intentar de Nuevo",
    backHome: "Volver al Inicio",
    successTitle: "¡Bienvenido a Pro!",
    successMessage: "Tu pago fue exitoso. Ahora tienes acceso completo a todas las funciones Pro.",
    successMessageWithAccount: "¡Tu cuenta está lista! Ahora tienes acceso completo a todas las funciones Pro.",
    unlockedFeatures: "Tus Beneficios Pro",
    feature1: "Reescritor de CV con IA - Optimiza tu CV al instante",
    feature2: "Generador de Carta de Presentación",
    feature3: "50 análisis por mes",
    feature4: "Preguntas de preparación para entrevistas",
    confirmationSent: "Se ha enviado un correo de confirmación a",
    startAnalyzing: "Comenzar a Analizar tu CV",
    supportNote: "¿Preguntas? Contáctanos en support@airesume.tailor",
    createAccount: {
      title: "¡Pago Exitoso!",
      subtitle: "Crea tu cuenta para acceder a tus funciones Pro",
      ...
      skip: "Omitir por ahora (puedes crear una cuenta después)",
      whyCreate: "Crea una cuenta para administrar tu suscripción y guardar análisis",
      errors: {
